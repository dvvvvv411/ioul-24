...
const About = () => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-orange-50 via-red-50 to-orange-50">
      ...
      {/* Notre Histoire - Reduced padding */}
      <section className="py-16 lg:py-20">
              ...
              {milestones.map((milestone, index) => (
                <Card key={index} className="bg-white/90 backdrop-blur-sm cozy-shadow border-0 organic-border text-center">
                  <CardContent className="p-6">
                    <div className="bg-gradient-to-br from-red-600 to-orange-600 text-white w-16 h-16 rounded-xl flex items-center justify-center mx-auto mb-4">
                      <span className="font-bold text-base">{milestone.year}</span>
                    </div>
                    <h4 className="font-semibold text-gray-900 mb-2 text-lg">{milestone.title}</h4>
      ...
      {/* Notre Engagement - Reduced padding */}
      <section className="py-16 lg:py-20">
        <div className="container mx-auto px-4">
          <div className="max-w-5xl mx-auto">
            <h2 className="text-4xl lg:text-5xl font-bold text-center text-gray-900 mb-12">
